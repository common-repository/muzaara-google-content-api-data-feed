...
class Rule extends \Muzaara\ProductFeed\Abs\Condition {
    ...
    public function getStmt() {
        return apply_filters( "muzaara_woopf_get_rule_statement", $this->stmt, $this );
    }

    public function execute( $product ) {
        do_action( "muzaara_woopf_before_rule_execute", $this, $product);
        ...
        do_action( "muzaara_woopf_after_rule_execute", $this, $product);
