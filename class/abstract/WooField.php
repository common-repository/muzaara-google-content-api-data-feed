...
abstract class WooField {
    ...
    public function getName() : string {
        return apply_filters( "muzaara_woopf_get_field_name", $this->name, $this );
    }

    public function getSlug() : string {
        return apply_filters( "muzaara_woopf_get_field_slug", $this->slug, $this );
    }

    public function getType() : int {
        return apply_filters( "muzaara_woopf_get_field_type", $this->type, $this );
    }

    public function getSuffix() : string {
        return apply_filters( "muzaara_woopf_get_field_suffix", $this->suffix, $this );
    }

    public function getPrefix() : string {
        return apply_filters( "muzaara_woopf_get_field_prefix", $this->prefix, $this );
    }

    public function getGField() : \Muzaara\ProductFeed\Object\GField {
        return apply_filters("muzaara_woopf_get_field_gfield", $this->gField, $this );
    }
    ...
    public function setGField(\Muzaara\ProductFeed\Object\GField $gField) {
        $this->gField = $gField;
    ...
    public function getTypeFriendly() : string {
        ...
        switch( $this->type ) {
            case self::PRODUCT_PROP:
                $ret = __( "Product", "muzaara-woopf" );
            break;
            case self::PRODUCT_META:
                $ret = __( "Meta Field", "muzaara-woopf" );
            break;
            case self::CUSTOM_FIELD:
                $ret = __( "Custom Field", "muzaara-woopf" );
            break;
            default:
                $ret = "";
        }
    ...
    public function getValue($product) {
            ...
            case self::PRODUCT_PROP:
                switch( $this->slug ) {
                    ...
                    case "stock_status":
                        ...
                        if ( 'instock' == $result ) {
                            $result = 'in_stock';
                        } else if ( 'outofstock' == $result ) {
                            $result = 'out_of_stock';
                        } else if ( 'onbackorder' == $result ) {
                            $result = 'backorder';
                        }
                    break;
                    case "categories":
        ...
        return apply_filters( "muzaara_woopf_get_field_value", $result, $this );
    }
}