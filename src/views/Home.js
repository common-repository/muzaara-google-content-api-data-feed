...
export default class Home extends React.Component {
    ...
    openNewTab() {
        this.setState({ authenticating : true }, () => {
            let t;
            let authWindow = window.open(MUZAARA_WOOPF.oauthUrl, "muzaara-woopf-auth", "status=1,width=500,height=700")
    ...
    checkAuth() {
        ...
        form.append( "action", "muzaara_woopf_checkAuth" )

        fetch(MUZAARA_WOOPF.ajax, {
    ...
    linkAccount() {
        this.setState({linking: true, linkingError: null}, () => {
            let form = new FormData()
            form.append( "action", "muzaara_woopf_linkAccount" )
    ...
    getAccounts() {
        this.setState({linkingError: null}, () => {
            let form = new FormData()
            form.append( "action", "muzaara_woopf_getAccounts" )
    ...
    render() {
        return(
            <div className="wrap">
                <h2>{MUZAARA_WOOPF.l10n.parentHeader}</h2>
